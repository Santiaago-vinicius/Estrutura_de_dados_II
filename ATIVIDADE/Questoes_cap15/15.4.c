...
// Função auxiliar recursiva para realizar a busca em profundidade
...
void dfs(struct Graph* graph, int startVertex) {
    ...
    // Chamar a função auxiliar recursiva para realizar a busca em profundidade
...
int main() {
    ...
    // Realizando a busca em profundidade a partir do vértice 0
